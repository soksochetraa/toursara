  ...
  return (
    <div>
      ...
      >
        ...
        <button className="flex justify-center items-center w-[125px] h-[39px] rounded-[50px] bg-[#EF3A45] text-white font-Lato text-[12px] font-[600] cursor-pointer absolute left-[315px] top-[231px] active:bg-white active:text-[#EF3A45] active:scale-95 ">
          Explore
        </button>
      </div>
    </div>
